...
export default function Slider({open}: OpenProps) {
    return (
        <div className={`h-[100svh] ${open ?'-translate-x-0' : '-translate-x-full' } transition-transform delay-200 mt-16  py-8 overflow-y-auto bg-teal-300 border-l border-r sm:w-64 w-60 dark:bg-gray-900 dark:border-gray-700`}>
