      ...
      <div className="grid lg:grid-cols-2 place-items-center pt-16 pb-8 md:pt-8">
        ...
        <div>
          ...
          <p className="text-lg mt-4 text-slate-600 dark:text-slate-400 max-w-xl">
            ...
            Omnisive is the most advanced AI chatbot that can help you with your daily
            tasks and answer your questions. <wbr /> It is a pre-trained general purpose
            chat system that can understand and answer any question you ask.
          </p>
